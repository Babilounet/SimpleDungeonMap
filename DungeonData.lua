...
SDM_DungeonBosses = {
    [33] = {
        ...
        bosses = {
            ...
            { "Jordan's Smithing Hammer", 32.1, 53.3, 1, "ShadowfangKeep", 16 },
            { "The Book of Ur", 44.9, 54.1, 4, "ShadowfangKeep", 17 },
        },
    },
    [34] = {
        atlasModule = "AtlasLootClassic_DungeonsAndRaids",
    ...
    [36] = {
        ...
        bosses = {
            ...
            { "Mr. Smite", 27.8, 40.1, 2, "TheDeadmines", 6 },
    ...
    [43] = {
        ...
        bosses = {
            ...
            { "Kresh", 37.6, 30.4, 1, "WailingCaverns", 3 },
            { "Lord Pythas", 69, 54.7, 1, "WailingCaverns", 4 },
            { "Skum", 53.9, 77.3, 1, "WailingCaverns", 5 },
            { "Lord Serpentis", 60.1, 46.7, 1, "WailingCaverns", 6 },
            { "Verdan the Everliving", 66, 72.5, 1, "WailingCaverns", 7 },
            { "Mutanus the Devourer", 54, 40.6, 1, "WailingCaverns", 8 },
            { "Deviate Faerie Dragon", 60.4, 64, 1, "WailingCaverns", 9 },
        },
    },
    [47] = {
        atlasModule = "AtlasLootClassic_DungeonsAndRaids",
    ...
    [90] = {
        ...
        bosses = {
            ...
            { "Dark Iron Ambassador", 30.6, 25.7, 4, "Gnomeregan", 6 },
    ...
    [129] = {
        ...
        bosses = {
            ...
            { "Ragglesnout", 34.9, 42, 1, "RazorfenDowns", 4 },
    ...
    [189] = {
        atlasModule = "AtlasLootClassic_DungeonsAndRaids",
        bosses = {
            { "Azshir the Sleepless", 70.5, 51.7, 1, "ScarletMonasteryGraveyard", 2 },
            { "Fallen Champion", 68.2, 49.8, 1, "ScarletMonasteryGraveyard", 3 },
            { "Ironspine", 70.8, 48.5, 1, "ScarletMonasteryGraveyard", 4 },
            { "Bloodmage Thalnos", 23.5, 48.8, 1, "ScarletMonasteryGraveyard", 5 },
            { "Scorn", 73.6, 50.2, 1, "ScarletMonasteryGraveyard", 7 },
            { "Headless Horseman", 68.4, 45.9, 1, "ScarletMonasteryGraveyard", 9 },
    ...
    [209] = {
        ...
        bosses = {
            ...
            { "Sandarr Dunereaver", 43.3, 15.3, 1, "Zul'Farrak", 3 },
            { "Witch Doctor Zum'rah", 28.8, 14.8, 1, "Zul'Farrak", 4 },
            { "Nekrum Gutchewer", 29.8, 18.3, 1, "Zul'Farrak", 5 },
            { "Shadowpriest Sezz'ziz", 24, 15.2, 1, "Zul'Farrak", 6 },
            { "Dustwraith", 31.7, 13.1, 1, "Zul'Farrak", 7 },
            { "Sandfury Executioner", 27.5, 32.6, 1, "Zul'Farrak", 8 },
            { "Sergeant Bly", 30.7, 35.5, 1, "Zul'Farrak", 9 },
            { "Hydromancer Velratha", 41.4, 29.1, 1, "Zul'Farrak", 10 },
    ...
    [309] = {
        ...
        bosses = {
            ...
            { "Bloodlord Mandokir", 58.9, 69.5, 1, "Zul'Gurub", 4 },
            ...
            { "High Priest Thekal", 61.1, 29.7, 1, "Zul'Gurub", 10 },
    ...
    [329] = {
        ...
        bosses = {
            ...
            { "Stratholme Courier", 79.7, 30.5, 1, "Stratholme", 2 },
            { "Hearthsinger Forresten", 83.1, 29.4, 1, "Stratholme", 3 },
            { "The Unforgiven", 72, 17.4, 1, "Stratholme", 4 },
            { "Timmy the Cruel", 38.4, 24.7, 1, "Stratholme", 6 },
            ...
            { "Magistrate Barthilas", 61, 65.3, 2, "Stratholme", 12 },
            { "Stonespine", 66.3, 63.6, 2, "Stratholme", 13 },
            { "Baroness Anastari", 66, 43.7, 2, "Stratholme", 14 },
    ...
    [389] = {
        atlasModule = "AtlasLootClassic_DungeonsAndRaids",
        bosses = {
            { "Taragaman the Hungerer", 52.6, 25.4, 1, "Ragefire", 1 },
            { "Jergosh the Invoker", 39.8, 50.1, 1, "Ragefire", 2 },
        },
    },
    [409] = {
        atlasModule = "AtlasLootClassic_DungeonsAndRaids",
        bosses = {
            ...
            { "Baron Geddon", 54, 73.7, 1, "MoltenCore", 6 },
    ...
    [429] = {
        ...
        bosses = {
            ...
            { "Knot Thimblejack's Cache", 61.2, 19.5, 1, "DireMaulNorth", 5 },
            ...
            { "Tribute", 56.6, 19.6, 1, "DireMaulNorth", 9 },
        },
    },
    [469] = {
        atlasModule = "AtlasLootClassic_DungeonsAndRaids",
...
-- SDM_DungeonStairs[instanceMapID][srcFloor][targetFloor] = { x, y }
